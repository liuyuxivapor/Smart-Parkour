...
const uint8_t camera_initial_reg[][3] = {
    
    0x31,0x03,0x11,// PCLK from pad
	0x30,0x08,0x82,// Software reset

	0x30,0x08,0x42,// Software power down
	0x31,0x03,0x03,// PCLK from PLL bit[1]:0:pad 1:pll

	0x30,0x17,0xff,// Set D output
	0x30,0x18,0xff,// 

	0x30,0x34,0x1A,// 10BIT MIPI MODE
	0x30,0x37,0x13,// PLL PRE-DIVIDER 3 ROOT-DIVIDER 2
	0x31,0x08,0x01,// SCLK = pll_clki/2 || SCLK2x = pll_clki || PCLK = pll_clki 
	...
	0x3a,0x13,0x43,// pre-gain enable pre-gain = 3
	0x3a,0x18,0x00,
	0x3a,0x19,0xf8,// AEC gain 0xf8
	0x36,0x35,0x13,
	0x36,0x36,0x03,
	0x36,0x34,0x40,
	0x36,0x22,0x01,
	...
	0x30,0x08,0x02,// wake up from standby


	0x30,0x35,0x21,
	0x30,0x36,0x46,// PLL x70
	0x3c,0x07,0x08,// PLL PRE-DIVIDER 8 || PLL ROOT DIVIDER BYPASS
	0x38,0x20,0x47,
	0x38,0x21,0x01,// ISP | SENSOR MIRROR  HORIZONTAL BINNING ENABLE
	0x38,0x14,0x31,// HORIZONTAL ODD 3 EVEN 1
	0x38,0x15,0x31,// VERTICAL ODD 3 EVEN 1

	0x38,0x00,0x00,
	0x38,0x01,0x00,// X_START : 0
	0x38,0x02,0x00,
	0x38,0x03,0x04,// Y_START : 4
	0x38,0x04,0x0a,
	0x38,0x05,0x3f,// X_END : 1855
	0x38,0x06,0x07,
	0x38,0x07,0x9b,// Y_END : 1947
	0x38,0x08,0x02,
	0x38,0x09,0x80,// DVP X SIZE : 640
	0x38,0x0a,0x01,
	0x38,0x0b,0xe0,// DVP Y SIZE : 480
	0x38,0x0c,0x07,
	0x38,0x0d,0x68,// TOTAL HORIZONTAL SIZE : 1869
	0x38,0x0e,0x03,
	0x38,0x0f,0xd8,// TOTAL VERTICAL SIZE : 984
	...
	0x3a,0x03,0x88,
	0x3a,0x14,0x0b,
	0x3a,0x15,0x88,// NIGHT MODE

	0x40,0x04,0x02,// blc line 2
	0x30,0x02,0x1c,// reset JFIFO | SFIFO JPG
	0x30,0x06,0xc3,// ENABLE PSRAM|FMT|FORMAT|VAERAGE CLOCK
	0x47,0x13,0x03,// JPEG MODE 3
	0x44,0x07,0x04,// JPEG QS 4
	0x46,0x0b,0x35,
	0x46,0x0c,0x22,// DVP PCLK DIVIDER BY 0X3824
	0x48,0x37,0x22,
	0x38,0x24,0x02,// DVP PCLK DIVIDE BY 2
	0x50,0x01,0xa7,// SE|SCALE|COLORMATRIX|AWB ENABLE  UV|DEBUG DISABLE
	0x35,0x03,0x00,// AEC|AGC AUTO ENABLE
	0x3b,0x00,0x83,
	0x3b,0x00,0x00,
	...
	0x38,0x0b,0xf0,// 240
	0x38,0x10,0x00,
	0x38,0x11,0x80,// X OFF : 128
	0x38,0x12,0x00,// 
	0x38,0x13,0xAC,// Y OFF : 4
	0x32,0x12,0x13,
	0x32,0x12,0xa3
...
const uint8_t RGB565_QVGA[][2]=
{    
    0x32,0x12, 0x03, // start group 3
    0x38,0x08, 0x01, // DVPHO = 320
    0x38,0x09, 0x40, // DVP HO
    0x38,0x0a, 0x00, // DVPVO = 240
    0x38,0x0b, 0xf0, // DVPVO
    0x38,0x10, 0x00, // H offset = 16
    0x38,0x11, 0x10, // H offset
    0x38,0x12, 0x00, // V offset = 4
    0x38,0x13, 0x04, // V offset
